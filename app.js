...
const scenePrompts = { maa_beti: Write a desi adult story in Hindi-English mixed style, based on classic pulp like Mastram. It should be emotionally intense, with vivid character emotions, realistic dialogue, deep physical and psychological interaction. Focus on a mother and daughter who share a house with a new male tenant. Use progressive buildup, inner thoughts, sensory detail, and realistic pacing. Never rush. Avoid any silly or robotic tone., madarsa: Write a dark, intense story set in an orthodox madarsa. Use Hindi-English style similar to underground desi novels. Include emotional tension, forced obedience, fear, shame, and raw desires. The story should have realistic pacing, dominant-submissive undertone, and no character crossover., tenant: Write an intense desi-style story about a lonely widow and her young daughter living in a rented house. A mysterious landlord visits often. Build tension, background, hesitation, cultural conflict and slow burning physical interactions. Include emotional realism and raw detail. Use Hindi-English mixed tone. };
